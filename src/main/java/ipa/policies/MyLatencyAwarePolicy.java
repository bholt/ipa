 ...
 * @since 1.0.4
 */
public class MyLatencyAwarePolicy implements ChainableLoadBalancingPolicy {
    ...
    public static class Builder {
         ...
         */
        public MyLatencyAwarePolicy build() {
            return new MyLatencyAwarePolicy(childPolicy, exclusionThreshold, scale, retryPeriod, updateRate, minMeasure);
        }
    }
